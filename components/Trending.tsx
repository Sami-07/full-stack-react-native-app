...
export default function Trending({ posts }: { posts: { id: any }[] }) {
    const zoomIn = {
        0: {
            scale: 0.9,
        },
        ...
        return (
            ...
            >
                {play ? (
                    ...
                    <ImageBackground source={{ uri: item.thumbnail }} className="w-52 h-72 rounded-[35px] my5 overflow-hidden shadow-lg shadow-black/40" resizeMode="cover" />
